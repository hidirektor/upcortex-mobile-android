package me.t3sl4.upcortex.UI.Components.Sneaker
...
import me.t3sl4.upcortex.UI.Components.Sneaker.Interfaces.OnSneakerClickListener
import me.t3sl4.upcortex.UI.Components.Sneaker.Interfaces.OnSneakerDismissListener
...
class Sneaker(private var context: Context) : View.OnClickListener, LifecycleObserver {
    ...
    fun sneakWarning() {
        ...
        mIconDrawable = ContextCompat.getDrawable(context, R.drawable.ikon_sneaker_warning)
    ...
    fun sneakError() {
        ...
        mIconDrawable = ContextCompat.getDrawable(context, R.drawable.ikon_sneaker_error)
    ...
    fun sneakSuccess() {
        ...
        mMessageColor = Color.parseColor("#FFFFFF")
        mIconColorFilterColor = Color.parseColor("#FFFFFF")
        mIconDrawable = ContextCompat.getDrawable(context, R.drawable.ikon_sneaker_success)
